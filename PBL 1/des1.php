    ...
    <style>
      * {
      ...
      body {
        ...
        min-height: 100vh;
        background: url("pnt1.jpg") no-repeat center;
      ...
      <div class="card-wrapper">
        <ul class="card-list swiper-wrapper">
          <li class="card-item swiper-slide">
            <img src="pnt1.jpg" alt="img-1" class="image-item" />
          </li>
          <li class="card-item swiper-slide">
            <img src="pnt2.jpg" alt="img-2" class="image-item" />
          </li>
          <li class="card-item swiper-slide">
            <img src="pnt3.jpg" alt="img-3" class="image-item" />
          </li>
          <li class="card-item swiper-slide">
            <img src="pnt4.jpg" alt="img-4" class="image-item" />
          </li>
          <li class="card-item swiper-slide">
            <img src="pnt5.jpg" alt="img-5" class="image-item" />
          </li>
          <li class="card-item swiper-slide">
            <img src="pnt6.jpg" alt="img-6" class="image-item" />
          </li>
          <li class="card-item swiper-slide">
            <img src="pnt7.jpg" alt="img-7" class="image-item" />
          </li>
        </ul>
